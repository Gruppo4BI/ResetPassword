                         ...
                         <i class="fa fa-refresh fa-3x"></i></h3>
                          ...
                          <p>Inserisci la tua email e una nuova password</p>
                            <div class="panel-body">
                              ...
                              <form class="form" name="new_password" action="http://localhost:8012/pswUpdate.php" method="POST" >
                                <fieldset>
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input id="email" name="email" placeholder="indirizzo email" class="form-control" type="email" oninvalid="setCustomValidity('Inserisci una password valida')" onchange="try{setCustomValidity('')}catch(e){}" required="">
                                    </div>
